...
class AlertController {
    ...
    fileprivate class var instance: AlertController {
        struct Static {
    ...
    fileprivate func topMostController() -> UIViewController? {
        ...
        if presentedVC == nil {
            print("AlertController Error: You don't have any views set")
            print("You may be calling in viewdidload. Try viewdidappear.")
        }
        return presentedVC
    }
    ...
    open class func alert(_ title: String,
                          ...
                          acceptBlock: @escaping () -> Void) -> UIAlertController {
